...
dependencias <- c('readr','dplyr','rstudioapi','magrittr','tidyverse','stringi','fitdistrplus')
...
| Código |  Nombres y Apellidos  |   Correo institucional  | Porcentaje de participación |
|:----------|:----------------------------:|--------------------------:|--------------------------:|
| 202110071 | Alexandro Martin Chamochumbi Gutierrez (Líder) | alexandro.chamochumb@utec.edu.pe | 100% |
| 202110280 | Juan Diego Prochazka Zegarra | juan.prochazka@utec.edu.pe | 100% |
| 202120445 | Jose Eddison Pinedo Espinoza | jose.pinedo@utec.edu.pe | 100% |
|  |  | @utec.edu.pe | 100% |
| 201820100 | Angello Italo Gino Paretto Castre | angello.paretto@utec.edu.pe | 100% |

- Estadística y Probabilidades I
- Sección: 2.01
- Profesor:Jose Miguel Renom Andara
...
+ `Codigo`: Tipo categórica nominal, está conformada por 9 dígitos. 

+ `Sexo`: Tipo categórica nominal, admite las siguientes respuestas: Masculino, Femenino o Prefiero no especificar.

+ `Edad`: Tipo numérica discreta positiva.

+ `Carrera`: Tipo categórica nominal, admite carreras ofrecidas en la UTEC.

+ `Ciclo`: Tipo numérica discreta, su restricción es que sea mayor o igual 1.

+ `Creditos`: Tipo numérica discreta, su restricción es que sea mínimo 16 y máximo 30.

+ `Vive_solo`: Tipo categórica nominal, puede ser Sí o No.

+ `Ha_jugado`: Tipo categórica nominal, puede ser Sí o No. Corresponde a si el alumno ha jugado algún videojuego.

+ `Gasto`: Tipo numérica continua, el valor debe ser mayor o igual a 0. Cuanto gastó el alumno en videojuegos en soles este año.

+ `Costo`: Tipo numérica continua, el valor debe ser mayor o igual a 0. Costo del último juego que el alumno compro.

+ `Frecuencia`: Tipo numérica continua, el valor debe ser mayor o igual a 0. Cuál es la cantidad de horas de juego del alumno en la semana.

+ `Estudio`: Tipo numérica continua, el valor debe ser mayor o igual a 0. Cuánto tiempo dedica el alumno a estudiar en la semana.

+ `Amigos`: Tipo categórica nominal, puede ser Sí o No. Refiere a si el alumno juega con amigos.

+ `Frecuencia_amigos`: Tipo numérica continua, el valor debe ser mayor o igual a 0. Refiere a la cantidad de horas que el alumno dedica a jugar con amigos en la semana.

+ `Promedio`: Tipo numérica continua, el valor debe ser mínimo 0 y máximo 20. Promedio del ciclo pasado o 5to de secundaria del alumno en caso sea primer ciclo.

+ `Afecta`: Tipo categórica nominal, puede ser Sí, No o Tal vez. Refiere a si el alumno piensa que el jugar videojuegos afecta sus estudios.

+ `Favorito`: Tipo categórica nominal, respuesta abierta. Videojuego favorito del alumno.

+ `Horas_juego`: Tipo numérica continua, el valor debe ser mayor o igual a 0. Horas de juego del alumno.

+ `Jugar_es_divertido`: Tipo categórica ordinal, admite valores enteros entre 1 y 7. Se refiere a si jugar es divertido para el alumno.

+ `Continua`: Tipo categórica ordinal, admite valores enteros entre 1 y 7. Refiere a si al comenzar a jugar un alumno quiere seguir haciéndolo.

+ `Bueno`: Tipo categórica ordinal, admite valores enteros entre 1 y 7. Refiere a si el alumno se considera bueno en videojuegos.

+ Preferencias: Las variables de preferencia son categóricas ordinales y admiten Si o No, refieren a si al alumno le gusta el género.
...
+ Plataforma: Las variables de plataforma pueden ser 'Si' o 'No'

  + `plataforma_consola`: Tipo categórica nominal. Refiere a si el alumno juega en móvil.

  + `plataforma_movil`: Tipo categórica nominal. Refiere a si el alumno juega en móvil.
  
  + `plataforma_pc`: Tipo categórica nominal. Refiere a si el alumno juega en pc.
  
  + `plataforma_tablet`: Tipo categórica nominal. Refiere a si el alumno juega en tablet.
...
barplot(pull(Amigos_Frecuencia[2],-1)[-12]
        ,names.arg = c('No','Sí')
        ,cex.names = 1
...
mean(DF$Cuantos_Generos)
sd(DF$Cuantos_Generos)
```
